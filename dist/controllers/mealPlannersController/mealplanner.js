...
exports.getMealPlanStats = getMealPlanStats;
// Handle meal plans with a 'plan' property (days of the week structure)
function handlePlanStructure(mealPlan, res) {
    try {
...
function handleMealsStructure(mealPlan, res) {
    try {
