...
class AIIntentDetector {
    ...
    static async generateStructuredContent(prompt, schema) {
        try {
            ...
            const outputParser = output_parsers_1.StructuredOutputParser.fromNamesAndDescriptions(schema);
...
exports.AIIntentDetector = AIIntentDetector;
