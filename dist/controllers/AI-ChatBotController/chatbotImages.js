...
exports.processMultiImageMessage = exports.processImageMessage = void 0;
...
console.log = function (...args) {
    ...
    try {
        ...
        fs_1.default.appendFileSync(path_1.default.join(process.cwd(), 'debug.log'), `[${new Date().toISOString()}] ${logMessage}\n`);
    }
    catch (e) { }
};
// Then test it
...
async function downloadImage(imageUrl) {
    try {
        ...
        const filePath = path_1.default.join(process.cwd(), 'uploads/chat-images', filename);
        // Save the image
...
const processImageMessage = async (req, res) => {
    var _a, _b;
    console.log('ENTERRR!');
    try {
        ...
        try {
            ...
            console.log('Before save - image count:', (_a = userMessage.images) === null || _a === void 0 ? void 0 : _a.length);
            // Save the message
            await userMessage.save();
            // Retrieve the saved message
            const savedMessage = await aiChatMessage_1.Message.findById(userMessage._id);
            console.log('After save - hasImages:', savedMessage.hasImages);
            console.log('After save - image count:', (_b = savedMessage.images) === null || _b === void 0 ? void 0 : _b.length);
...
const processMultiImageMessage = async (req, res) => {
    var _a;
    try {
        ensureUploadDirExists();
        const userId = req.user._id;
        ...
        console.log('Processing multiple images:', (imageUrls === null || imageUrls === void 0 ? void 0 : imageUrls.length) || 0);
        ...
        if (imageUrls && imageUrls.length > 0) {
            ...
            const urlPromises = imageUrls.map(async (url) => {
                try {
        ...
        const userMessage = new aiChatMessage_1.Message(userMessageData);
        await userMessage.save();
        // Verify what was saved
        const savedMessage = await aiChatMessage_1.Message.findById(userMessage._id);
        console.log('Retrieved after save:', {
            hasImages: savedMessage.hasImages,
            imageCount: ((_a = savedMessage.images) === null || _a === void 0 ? void 0 : _a.length) || 0
        });
        // Update chat's last message and activity
...
exports.processMultiImageMessage = processMultiImageMessage;
// Helper function to generate AI response for image
async function generateAIResponseForImage(message, userId) {
    var _a, _b;
    try {
        const image = message.images[0];
        const textPrompt = message.content || '';
        // If this is a food image
        if ((_b = (_a = image.analysis) === null || _a === void 0 ? void 0 : _a.foodRecognition) === null || _b === void 0 ? void 0 : _b.isDish) {
...
async function generateAIResponseForMultipleImages(message, userId) {
    try {
        const images = message.images;
        const textPrompt = message.content || '';
        const foodImages = images.filter((img) => { var _a, _b; return (_b = (_a = img.analysis) === null || _a === void 0 ? void 0 : _a.foodRecognition) === null || _b === void 0 ? void 0 : _b.isDish; });
...
I can see dishes like ${foodImages.map(img => { var _a, _b; return ((_b = (_a = img.analysis) === null || _a === void 0 ? void 0 : _a.foodRecognition) === null || _b === void 0 ? void 0 : _b.dishName) || 'a dish'; }).join(', ')}. Would you like me to:
...
Some of them appear to be food dishes like ${foodImages.map(img => { var _a, _b; return ((_b = (_a = img.analysis) === null || _a === void 0 ? void 0 : _a.foodRecognition) === null || _b === void 0 ? void 0 : _b.dishName) || 'a dish'; }).join(', ')}. Which ones would you like me to focus on?`;
        }
        // Non-food images
