...
exports.trackStepCompletion = exports.getCookingStatus = exports.didntCook = exports.completeCooking = exports.startCooking = void 0;
...
const startCooking = async (req, res) => {
    try {
        ...
        const existingSession = await recipeInterractionModel_1.default.findOne({
            userId,
            recipeId,
        ...
        if (existingSession) {
            ...
            interaction = new recipeInterractionModel_1.default({
                userId,
                recipeId,
...
const completeCooking = async (req, res) => {
    try {
        ...
        const interaction = await recipeInterractionModel_1.default.findOne({
            userId,
            recipeId,
...
exports.completeCooking = completeCooking;
// Didn't cook / Abandon cooking
const didntCook = async (req, res) => {
    try {
        const userId = req.user._id;
...
exports.didntCook = didntCook;
// Get cooking status for a recipe
const getCookingStatus = async (req, res) => {
    try {
        const userId = req.user._id;
        ...
        return res.status(200).json({
            ...
            data: {
                ...
                currentStatus: (interaction === null || interaction === void 0 ? void 0 : interaction.status) || 'not_started',
                isVerifiedCook: (interaction === null || interaction === void 0 ? void 0 : interaction.isVerifiedCook) || false,
                sessionId: (interaction === null || interaction === void 0 ? void 0 : interaction.sessionId) || null,
                startedAt: (interaction === null || interaction === void 0 ? void 0 : interaction.startedAt) || null,
                completedAt: (interaction === null || interaction === void 0 ? void 0 : interaction.completedAt) || null,
                totalCookingTime: (interaction === null || interaction === void 0 ? void 0 : interaction.totalCookingTime) || 0
            }
        });
    }
    catch (error) {
...
exports.getCookingStatus = getCookingStatus;
// Helper function to update meal plan status
async function updateMealPlanStatus(mealPlanId, recipeId, status) {
    try {
        // This would depend on your meal plan schema structure
        // You might need to update specific day/meal entries
        await meal_planner_1.default.findByIdAndUpdate(mealPlanId, {
            $addToSet: {
                completedRecipes: {
                    recipeId,
                    status,
...
const trackStepCompletion = async (req, res) => {
    try {
        const userId = req.user._id;
...
exports.trackStepCompletion = trackStepCompletion;
